...
public class EliminarDetalleProductoPedidoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button eliminar=vista.findViewById(R.id.btn_eliminarDetalleProductoPedido);

        final EditText idBuscarDetalle=vista.findViewById(R.id.editText_eliminarDetalleProductoPedido);
        ...
        eliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<List<DetalleProductoPedido>> call=apiServices.eliminarDetalleProductoPedido(Integer.parseInt(idBuscarDetalle.getText().toString()));
